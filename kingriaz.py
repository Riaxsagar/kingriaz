...
\033[1;96m(~)\033[1;97m Author : RIAZ\033[1;97m[ \033[0;92m Best FRIEND NADIR-ALI \033[1;97m]

\033[1;96m(~)\033[1;97m Github : http://github.com/Riaxsagar/kingriaz.git

\033[1;96m(~)\033[1;97m Fb     :  Mai Hon tera bap
...
def main_select():
    ...
    if Abdullah =="2":
        ...
        os.system("xdg-open https://www.facebook.com/MaiHon tera bap")
...
def login_select():
	...
	print("")
	    ...
	    os.system("xdg-open https://www.facebook.com/Mai Hon tera bap/?app=fbl")
	    ...
	    time.sleep(1)
            ...
            print("\033[1;91mToken invalid or account has RIAZ-CP\033[0;97m").center(50)
...
def menu():
    ...
    try:
        ...
        print("login account has RIAZ-CP").center(50)
...
def menu_select():
	...
	if select =="2":
		...
		try:
		    ...
		    print("\033[1;91m login id has RIAZ-CP").center(50)
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;96m[RIAZ-CP] "+uid+" | "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;96m[RIAZ-CP] "+uid+" | "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;96m[RIAZ-CP] "+uid+" | "+pass4)
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;96m[RIAZ-CP] "+uid+" | "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;96m[RIAZ-CP] "+uid+" | "+pass7)
